 ...
 * @author Shamil
 */
public class EditBarcode extends javax.swing.JDialog {

    String barcode;

    public EditBarcode(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Yeni barkodu qeyd et");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditBarcode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditBarcode dialog = new EditBarcode(new javax.swing.JFrame(), true);
